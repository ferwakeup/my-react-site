 ...
 * Responsive optimized for Mobile Safari
 */
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-300 font-sans selection:bg-zinc-100 selection:text-black antialiased">
      ...
      <main>
        ...
        <section className="relative min-h-[90vh] md:min-h-screen flex flex-col justify-center px-6 md:px-12 overflow-hidden pt-20 md:pt-0">
          ...
          <div className="relative z-10 max-w-7xl mx-auto w-full">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900/50 text-zinc-500 text-[9px] md:text-[10px] uppercase tracking-[0.2em] mb-6 md:mb-8">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-[9.5rem] font-light text-white leading-[1.1] md:leading-[0.9] tracking-tighter mb-8 md:mb-10 drop-shadow-2xl">
                Building <br />
        ...
        <section id="about" className="py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto border-t border-zinc-900">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-12 mt-12 md:mt-16">
            ...
            <div className="space-y-4 group">
              ...
              <p className="text-sm md:text-base text-zinc-500 font-light leading-relaxed">
                Ground from zero to an IBEX35 investment. I've "eaten glass" to find product-market fit when the market didn't even know it needed it.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-center justify-center">
            {[
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="group p-6 md:p-8 text-center bg-zinc-900/30 border border-zinc-900 rounded-3xl hover:border-zinc-700 hover:bg-zinc-900/50 transition-all"
              >
                <span className="text-zinc-500 group-hover:text-white font-medium tracking-tight transition-colors text-sm md:text-base">
                  {v.name}
                </span>
              </a>
            ))}
        ...
        <section id="contact" className="py-20 md:py-32 mb-10 md:mb-20 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="bg-zinc-900/30 rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 border border-zinc-900 shadow-2xl shadow-black/50">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
                <div className="space-y-10 md:space-y-12">
                  <div>
                    <h4 className="text-[10px] font-mono uppercase tracking-[0.3em] text-zinc-600 mb-6 md:mb-8">Direct Channels</h4>
                    <div className="space-y-4 md:space-y-6">
                      ...
                      <button 
                        ...
                        className="flex items-center gap-4 text-base md:text-xl text-white hover:text-zinc-400 transition-colors text-left"
                      >
                  ...
                  <div className="p-8 md:p-10 bg-zinc-950/50 border border-zinc-800 rounded-[2rem] md:rounded-[2.5rem] shadow-inner">
                    <p className="text-zinc-400 italic font-light leading-relaxed text-base md:text-lg">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <input 
                      ...
                      type="text" 
                      placeholder="Name" 
                      className="w-full bg-zinc-950 border border-zinc-900 p-4 md:p-5 rounded-2xl focus:border-zinc-500 outline-none transition-all text-white text-sm"
                    />
                    <input 
                      required
                      type="email" 
                  ...
                  <textarea 
                    ...
                    rows="4"
                    className="w-full bg-zinc-950 border border-zinc-900 p-4 md:p-5 rounded-2xl focus:border-zinc-500 outline-none transition-all text-white resize-none text-sm"
                  ></textarea>
                  <button 
                    type="submit"
                    className="w-full bg-white text-black py-4 md:py-6 rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-zinc-200 transition-all text-base md:text-lg shadow-xl"
                  >
                    {formStatus || 'Send Inquiry'} <Send size={18} />
                  </button>
                  {formStatus && <p className="text-center text-[10px] md:text-xs text-zinc-500 font-mono mt-4">{formStatus}</p>}
                </form>
              </div>
            </div>
          </div>
      ...
      <footer className="max-w-7xl mx-auto px-6 md:px-12 py-10 md:py-12 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8 text-[9px] md:text-[10px] font-mono uppercase tracking-[0.2em] md:tracking-[0.3em] text-zinc-600 text-center md:text-left">
